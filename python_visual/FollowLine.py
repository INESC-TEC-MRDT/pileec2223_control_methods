...
bag = rosbag.Bag('/home/ze/Python/FL.bag')
...
x_line = np.array([-1, 2])  # Extend the line beyond the given points
y_line = (move_goal_y / move_goal_x) * (x_line - 0)
ax1.plot(x_line, y_line,'p-', linewidth=1)
